	...
	Keen.ready(function(){
		var viewedT= new Keen.Query("funnel",{
	steps:[
	{
	...
	{
		event_collection:"Show Trading Tutorial",
		actor_property:"userId"
	}
	]
	});
		client.draw(viewedT,document.getElementById("my_chart"),{
			library:"google",
			chartType:"columnchart",
			width:1000,
			height:800,
			title:"External Visitors Show Trading Tutorial"
