	...
	Keen.ready(function(){
		var tutorial= new Keen.Query("funnel",{
			steps:[
			{
			...
			{
				event_collection:"Show Overview Tutorial",
			...
			{
				event_collection:"Show Spectrum Tutorial",
				actor_property:"userId"
		...
		client.draw(tutorial,document.getElementById("my_chart"),{
			chartType:"columnchart",
			title:"viewed OverView & Spectrum Tutorial",
			width:1000,
			height:800,
			chartOptions:{
				legend:{postion:"top"},
