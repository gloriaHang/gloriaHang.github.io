var client = new Keen({
				...
				Keen.ready(function(){
					var credit = new Keen.Query("funnel",{
						steps:[
						{
						...
						{
							event_collection:"Updated Credit Card",
							actor_property:"keen.id"
						}
						]
					...
					client.draw(credit,document.getElementById("my_chart"),{
						library:"google",
						chartType:"columnchart",
						width:1000,
						height:800,
						title:"Visitors Updated Credit card",
