var client = new Keen({
	...
	Keen.ready(function(){
		  var trade = new Keen.Query("count", {
    		eventCollection: "Show Trading Tutorial",
    		groupBy: "userId",
    		filters: [{"property_name":"Replay","operator":"exists","property_value":true}]
			});
	client.draw(trade,document.getElementById("my_chart"),{
		library:"google",
		chartType:"linechart",
		width:600,
		height:600,
		title:"Show & Replay Trading Tutorial"
	});
	});