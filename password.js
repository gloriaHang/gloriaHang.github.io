...
Keen.ready(function(){
	var passWord = new Keen.Query("funnel",{
		steps:[
		{
		...
		{
			event_collection:"Viewed Password Request Page",
			actor_property:"user.userId",
			inverted:true,
			optional:true,
			with_actors:true
         ...
         {
         	event_collection:"Viewed Password Reset Page",
         	actor_property:"user.userId"
	...
	client.draw(passWord,document.getElementById("my_chart"),{
		library:"google",
		chartType:"columnchart",
		width:1000,
		height:800,
		title:"External Visitors Password Request&Reset"
	});
});